...
const char spritesheet_fullfilename[]  = "../Dependencies/Resources/sprites.bmp";
const char paddle_sound_fullfilename[] = "../Dependencies/Resources/paddle.wav";
const char edge_sound_fullfilename[]   = "../Dependencies/Resources/edge.wav";
const char point_sound_fullfilename[]  = "../Dependencies/Resources/point.wav";
